...
"use strict";var e=n(require("speak-tts"));function n(e){return e&&e.__esModule?e:{default:e}}var t=function(e){var n=window.document.createElement("div"),t='<h2>Available Voices</h2><select id="languages"><option value="">autodetect language</option>';e.forEach(function(e){t+='<option value="'.concat(e.lang,'" data-name="').concat(e.name,'">').concat(e.name," (").concat(e.lang,")</option>")}),n.innerHTML=t,window.document.getElementById("mainHeader").appendChild(n)},o=["adventure","structure","mysterious","appreciation","furniture","maintenance","ascending","surprise","scariest","expenditure","bracket","sequence","moisture","received","etiquette","constitution","foreign","discussion","scholarship","camouflage","recommend","mathematician","announcement","plateau","sculpture","humorous","perseverance","interrogation","successful","musician"],r=0,c=0,a=0,s=0;function u(){var n=new e.default;n.init({volume:.5,lang:"en-GB",rate:1,pitch:1,listeners:{onvoiceschanged:function(e){console.log("Voices changed",e)}}}).then(function(e){console.log("Speech is ready",e),t(e.voices),i(n)}).catch(function(e){console.error("An error occured while initializing : ",e)});var o=n.hasBrowserSupport()?"Hurray, your browser supports speech synthesis":"Your browser does NOT support speech synthesis. Try using Chrome of Safari instead !";document.getElementById("support").innerHTML=o}function i(e){var n=document.getElementById("play"),t=document.getElementById("pause"),u=document.getElementById("resume"),i=document.getElementById("startMyTraining"),l=document.getElementById("submitAnswer"),d=document.getElementById("inputAnswer"),m=document.getElementById("mainHeader"),g=document.getElementById("trainingArena"),p=document.getElementById("text"),f=document.getElementById("languages"),y=document.getElementById("scoreCounter"),h=document.getElementById("wrongAttempts"),v=document.getElementById("currentWrongAttempts"),E="cat";n.addEventListener("click",function(){var n=f.value,t=f.options[f.selectedIndex].dataset.name;n&&e.setLanguage(f.value),t&&e.setVoice(t),e.speak({text:p.innerText,queue:!1,listeners:{onstart:function(){console.log("Start utterance")},onend:function(){console.log("End utterance")},onresume:function(){console.log("Resume utterance")},onboundary:function(e){console.log(e.name+" boundary reached after "+e.elapsedTime+" milliseconds.")}}}).then(function(e){console.log("Success !",e),m.hidden=!0,g.classList.remove("d-none")}).catch(function(e){console.error("An error occurred :",e)})}),t.addEventListener("click",function(){e.pause()}),u.addEventListener("click",function(){e.resume()}),l.addEventListener("click",function(){if(d.value.toLowerCase()===E.toLocaleLowerCase()){r%2==0?(console.log("odd score"),e.speak({text:"Very Good my Friend. Now for the next word",queue:!1}),setTimeout({},2e3)):(console.log("even score"),e.speak({text:"Great Going buddy. Your current score is :"+r+"points. Next word coming up",queue:!1}));var n=-1*s+10;r+=n>0?n:1,y.innerText=r,function(){s>0&&(a++,h.innerText=a);s=0,v.innerText="0",d.value="",d.style.backgroundColor="white",a>3?e.speak({text:"Sorry! You have Exceeded all the lifelines. Your Final Score is ".concat(r,". Please restart to try again."),queue:!1}):c>=o.length?e.speak({text:"You have completed Training for all the words today. Your Final score is "+r+" points",queue:!1}):(E=o[c],e.speak({text:"Ready for Next Word..., spell "+E,queue:!1}));c++}()}else s++,v.innerText=s,e.speak({text:"Sorry That was an Incorrect Answer. Try Again!",queue:!1}),d.style.backgroundColor="red"}),i.addEventListener("click",function(){submitAnswer.disabled=!1,e.speak({text:"Spell "+E,queue:!1,listeners:{onstart:function(){i.value="Play Word",console.log("Start utterance")},onend:function(){console.log("End utterance")},onresume:function(){console.log("Resume utterance")},onboundary:function(e){console.log(e.name+" boundary reached after "+e.elapsedTime+" milliseconds.")}}}).then(function(e){console.log("Success !",e),i.innerText="Play Word"}).catch(function(e){console.error("An error occurred :",e)})})}u();
},{"speak-tts":"ovRn"}]},{},["vZyd"], null)
//# sourceMappingURL=/app.bbb66f87.js.map