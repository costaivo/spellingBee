...
var _wordsToSpell = ['adventure', 'structure', 'mysterious', 'appreciation', 'furniture', 'maintenance', 'ascending', 'surprise', 'scariest', 'expenditure', 'bracket', 'sequence', 'moisture', 'received', 'etiquette', 'constitution', 'foreign', 'discussion', 'scholarship', 'camouflage', 'recommend', 'mathematician', 'announcement', 'plateau', 'sculpture', 'humorous', 'perseverance', 'interrogation', 'successful', 'musician'];
var scoreCount = 0;
var wordIndex = 0;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8243" + '/');
